      ...
      function redraw() {
        ...
        visB
          ...
          .on("mouseover", function (d) {
            if (d.label !== null) {
              ...
              let tooltipText = "";
              if (d.parent || d.dist) {
                tooltipText += `<b>Parent:</b> ${
                  d.parent
                }<br/><b>Genomic distance:</b> ${
              ...
              tooltipText += `<b>Collection dates:</b><br>${formatDate(
                d.x1
              )} / ${formatDate(d.x2)}`;
        ...
        visB
          ...
          .on("mouseover", function (d) {
            ...
            tooltipText += `<b>Genomic distance:</b> ${
              Math.round(d.dist * 100) / 100
            }<br>`;
        ...
        visBaxis
          ...
          .call(d3.axisTop(xScaleB).ticks(5).tickFormat(d3.timeFormat("%Y-%m-%d")));
      }
      redraw();
