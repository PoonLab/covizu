...
req.done(async function() {
  ...
  display_info["non_recombinants"] = {"first": d3.timeDay.offset(tips[0].first_date, -1 * YEAR * tips[0].branchLength), "last": d3.max(tips, function(d) {return d.last_date})};
  display_info["xbb"] = {"first": d3.timeDay.offset(xbb_tips[0].first_date, -1 * YEAR * xbb_tips[0].branchLength), "last": d3.max(xbb_tips, function(d) {return d.last_date})};
